...
public class ProcessoDTO {
    ...
    @Schema(description = "Número único do processo", example = "12345/2023", required = true)
    @NotBlank(message = "O número do processo é obrigatório!")
    private String numeroProcesso;

    @Schema(description = "Tipo do processo", example = "Administrativo", required = true)
    @NotBlank(message = "O tipo do processo é obrigatório!")
    private String tipoProcesso;

    @Schema(description = "Origem do processo", example = "Protocolo", required = true)
    @NotBlank(message = "A origem do processo é obrigatória!")
    private String origem;

    @Schema(description = "Unidade atual do processo", example = "Setor de Protocolo", required = true)
    @NotBlank(message = "A unidade atual é obrigatória!")
    private String unidadeAtual;

    @Schema(description = "Status atual do processo", example = "Em andamento", required = true)
